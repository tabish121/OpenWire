...
public abstract class MessageMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        info.setProducerId((io.openwire.commands.ProducerId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setDestination((OpenWireDestination) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setTransactionId((io.openwire.commands.TransactionId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setOriginalDestination((OpenWireDestination) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setMessageId((io.openwire.commands.MessageId) tightUnmarsalNestedObject(wireFormat, dataIn, bs));
        info.setOriginalTransactionId((io.openwire.commands.TransactionId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        ...
        info.setTargetConsumerId((io.openwire.commands.ConsumerId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setCompressed(bs.readBoolean());
        info.setRedeliveryCounter(dataIn.readInt());

        if (bs.readBoolean()) {
            short size = dataIn.readShort();
            io.openwire.commands.BrokerId value[] = new io.openwire.commands.BrokerId[size];
            for (int i = 0; i < size; i++) {
                value[i] = (io.openwire.commands.BrokerId) tightUnmarsalNestedObject(wireFormat, dataIn, bs);
            }
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn) throws IOException {
        ...
        info.setProducerId((io.openwire.commands.ProducerId) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setDestination((OpenWireDestination) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setTransactionId((io.openwire.commands.TransactionId) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setOriginalDestination((OpenWireDestination) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setMessageId((io.openwire.commands.MessageId) looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setOriginalTransactionId((io.openwire.commands.TransactionId) looseUnmarsalCachedObject(wireFormat, dataIn));
        ...
        info.setTargetConsumerId((io.openwire.commands.ConsumerId) looseUnmarsalCachedObject(wireFormat, dataIn));
        ...
        if (dataIn.readBoolean()) {
            ...
            io.openwire.commands.BrokerId value[] = new io.openwire.commands.BrokerId[size];
            for (int i = 0; i < size; i++) {
                value[i] = (io.openwire.commands.BrokerId) looseUnmarsalNestedObject(wireFormat, dataIn);
            }
            info.setBrokerPath(value);
        } else {
            info.setBrokerPath(null);
